...
### Asylum.Net.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Asylum.Net.Analyzers.Sample.csproj](../Asylum.Net.Analyzers.Sample/Asylum.Net.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Asylum.Net.Analyzers.Tests
